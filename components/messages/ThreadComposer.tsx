    ...
    <form onSubmit={handleSubmit} className="border-t border-neutral-200 dark:border-line p-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          placeholder={disabled ? "Дождитесь ответа…" : "Написать сообщение…"}
          disabled={disabled}
          className="flex-1 border border-neutral-300 dark:border-line bg-white dark:bg-panel px-3 py-2 text-sm text-neutral-900 dark:text-neutral-100 outline-none focus:border-neutral-400 disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={disabled || isPending || uploading || (!text.trim() && !file)}
