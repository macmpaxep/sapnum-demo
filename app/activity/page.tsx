...
export default async function ActivityPage() {
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50">Активность на вашей странице</h1>
      ...
      <div className="mt-4 divide-y divide-neutral-100 border border-neutral-200 dark:border-neutral-800">
        {activity.map((a) => (
          <div key={a.id} className="px-4 py-3 text-sm">
            <span className="font-medium text-neutral-900 dark:text-neutral-50">{a.actorName}</span>{" "}
