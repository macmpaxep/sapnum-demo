    ...
    <div className="rounded-lg border border-neutral-200 dark:border-line p-4">
      ...
      <div className="mt-3 space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div className="h-2 flex-1 bg-neutral-100 dark:bg-line">
            <div className="h-2 bg-neutral-900" style={{ width: `${mine}%` }} />
          </div>
          <span className="num w-10 shrink-0 text-right font-mono text-xs text-neutral-900 dark:text-paper">
            {mine}%
          </span>
        </div>
        <div className="flex items-center gap-3">
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[240px_minmax(0,1fr)_320px]">
      ...
      <main className="min-w-0 space-y-4">
        <div>
          <h1 className="text-lg font-semibold text-neutral-900 dark:text-paper">Показатели</h1>
        ...
        <div className="grid grid-cols-1 gap-4">
          {metricRows.map((row) => (
            <div key={row.label} className="flex items-center justify-between rounded-lg border border-neutral-200 dark:border-line p-4">
              <div>
                <div className="text-xs text-neutral-500 dark:text-neutral-400">{row.label}</div>
                <div className="num mt-1 font-mono text-xl text-neutral-900 dark:text-paper">
                  {row.value}
                </div>
              </div>
          ...
          <div className="flex items-center justify-between rounded-lg border border-neutral-200 dark:border-line p-4">
