...
export default async function CompaniesPage({
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50">Компании</h1>
      ...
      <div className="mt-4 divide-y divide-neutral-100 border border-neutral-200 dark:border-neutral-800">
        {companies.map((c) => (
          <Link key={c.slug} href={`/co/${c.slug}`} className="flex items-center gap-3 px-4 py-3 hover:bg-neutral-50 dark:hover:bg-neutral-900">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 text-xs font-medium text-neutral-500 dark:text-neutral-400">
