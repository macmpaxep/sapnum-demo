...
export default async function CompaniesPage({
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-neutral-900">Компании</h1>
      <p className="mt-1 text-sm text-neutral-500">Бизнесы, зарегистрированные на SAPNUM.</p>

      <div className="mt-4">
        <SearchBox placeholder="Поиск по названию или отрасли…" />
      </div>

      {companies.length === 0 && <p className="mt-6 text-sm text-neutral-500">Компаний не найдено.</p>}
