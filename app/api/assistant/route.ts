...
Отвечай обычным текстом без markdown-разметки: без заголовков (#), без **жирного**, без таблиц и списков
через дефис — ответ выводится как простой текст, разметка будет видна как мусорные символы.`;
